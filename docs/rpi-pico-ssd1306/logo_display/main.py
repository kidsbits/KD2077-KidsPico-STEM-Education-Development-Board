###############################################################
# SSD1306 OLED Display I2C Tests with the KidsPico
# keyestudio
# 2024
###############################################################
...
i2c_dev = I2C(0,scl=Pin(5),sda=Pin(4),freq=200000)  # start I2C on I2C1 (GPIO 26/27)
...
txt_array = ['KidsPico','2024','Demo'] # text array
